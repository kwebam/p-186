...
def saveData():
    ...
    file = (file_name + ".txt", "w")
    
    data = encryption_text_data.get("1.0", END)
    cipher_code = encrypt("ghcndfjvhfnmhfutgyvndhdfjkgmvsendsmgtjfcfdyfrgcbjtgyvhbftjfhhhrgfnfjuhfhnuyrjefherutuiyfg", data)
    messagebox.showinfo("Data", "Successfully Updated")
...
def startEncryption():
    ...
    file_name_label = Label(encryption_window, text="File Name: " , font = 'arial 13', bg = "green")
    ...
    btn_create = Button(encryption_window, text="Create", font = 'arial 13', command = saveData, bg = "green", relief = FLAT, padx = 10, pady = 10)
...
btn_start_encryption = Button(root, text="Start Encryption" , font = 'arial 13' , command=startEncryption, bg = "green", relief = FLAT, padx = 10, pady = 10)
btn_start_encryption.place(relx=0.3,rely=0.6, anchor=CENTER)

btn_start_decryption = Button(root, text="Start Decryption" , font = 'arial 13' ,  command=startDecryption, bg = "green", relief = FLAT, padx = 10, pady = 10)
